      ...
      <Container sx={{ width: 900 }}>
        ...
        <Box>
          ...
          <Typography variant="paragraph" component="h4" marginTop={3}>
            About this ticket contentAbout this ticket contentAbout this ticket
            contentAbout this ticket contentAbout this ticket contentAbout this
            ticket contentAbout this ticket content
          </Typography>
        </Box>
        <Box>
